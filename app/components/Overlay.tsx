        ...
        <div ref={containerRef} className="absolute top-0 left-0 w-full h-[500vh] pointer-events-none z-10">
            ...
            >
                <h1 className="text-5xl md:text-8xl font-bold tracking-tighter text-white mix-blend-difference">
                    Naveen Saragadam.<br />
                    <span className="text-gray-400 text-2xl md:text-5xl mt-4 block">Data Engineer.</span>
                </h1>
            </motion.div>
            ...
            >
                <div className="text-right max-w-2xl">
                    <h2 className="text-3xl md:text-6xl font-bold text-white mb-6 leading-tight">
                        Modernizing Infrastructure for <span className="text-orange-500">Fortune 100</span> Leaders.
                    </h2>
                    <p className="text-lg md:text-xl text-gray-300 leading-relaxed ml-auto">
                        Driving transformation at <strong>Target</strong> and <strong>General Motors</strong>.
                        I specialize in <strong>Scalable Data Pipelines</strong> and <strong>Lakehouse Architectures</strong> that empower critical business decisions.
                    </p>
                </div>
            </motion.div>
            ...
            >
                <div className="max-w-3xl">
                    ...
                    <p className="text-lg md:text-xl text-gray-400 leading-relaxed max-w-2xl">
                        I migrated <strong>20+ legacy Hadoop/Hive systems</strong> to PySpark, supporting 300+ downstream reports.
                        My robust data quality frameworks ensure 99.9% SLA reliability for critical pricing decisions.
                    </p>
                </div>
            </motion.div>
