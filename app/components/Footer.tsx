        ...
        <footer className="relative z-10 w-full bg-zinc-50 dark:bg-[#050505] overflow-hidden transition-colors duration-300">
            ...
            <div className="relative z-10 max-w-[1400px] mx-auto px-6 md:px-12 pt-32 pb-12">
                ...
                <div className="flex flex-col items-center text-center space-y-10 mb-40">
                    ...
                    >
                        FROM STRATEGY TO <span className="text-zinc-400 dark:text-white/60">EXECUTION</span><br />
                         LET'S BUILD IT <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 dark:from-blue-400 dark:via-purple-400 dark:to-pink-400">TOGETHER!</span>
                    </motion.h2>
                    ...
                    >
                        I'm available for full-time Data Analyst & Analytics Engineering roles.
                        <br />
                        <span className="text-sm text-zinc-500 dark:text-zinc-600 block mt-3 font-normal">Tucson, AZ · +1 (520) 535-5599</span>
                    </motion.p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-16 md:gap-8 mb-24">
                    ...
                    <div className="md:col-span-4 space-y-8">
                        ...
                        <p className="text-zinc-600 dark:text-zinc-500 max-w-xs leading-relaxed">
                            Data Analyst with 4 years of experience across data analytics, analytics engineering, and BI in Fortune 100 environments.
                        </p>
                    ...
                    <div className="md:col-span-8 grid grid-cols-2 md:grid-cols-3 gap-12 md:gap-8">
                        ...
                        <div className="space-y-8">
                            ...
                            <ul className="space-y-5">
                                <li><Link href="/" className="text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-white transition-colors duration-300" suppressHydrationWarning>Home</Link></li>
                                <li><Link href="/journey" className="text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-white transition-colors duration-300" suppressHydrationWarning>Journey</Link></li>
                                <li><Link href="/work" className="text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-white transition-colors duration-300" suppressHydrationWarning>Work</Link></li>
                            </ul>
                        </div>
                        ...
                        <div className="space-y-8">
                            ...
                            <ul className="space-y-5">
                                <li><Link href="/guestbook" className="text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-white transition-colors duration-300" suppressHydrationWarning>Guest Book</Link></li>
                                <li><Link href="#" className="text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-white transition-colors duration-300" suppressHydrationWarning>Bucket List</Link></li>
                                <li><Link href="#" className="text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-white transition-colors duration-300" suppressHydrationWarning>Uses</Link></li>
                                <li><Link href="#" className="text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-white transition-colors duration-300" suppressHydrationWarning>Attribution</Link></li>
                            </ul>
                        </div>
                        ...
                        <div className="space-y-8">
                            ...
                            <ul className="space-y-5">
                                <li><a href="mailto:naveens@arizona.edu" className="text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-white transition-colors duration-300" suppressHydrationWarning>Book a call</a></li>
                                <li><a href="#" className="text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-white transition-colors duration-300" suppressHydrationWarning>Links</a></li>
                                <li><Link href="#" className="text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-white transition-colors duration-300" suppressHydrationWarning>RSS</Link></li>
                                <li><Link href="#" className="text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-white transition-colors duration-300" suppressHydrationWarning>Privacy</Link></li>
                                <li><Link href="#" className="text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-white transition-colors duration-300" suppressHydrationWarning>Terms</Link></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div className="pt-10 border-t border-zinc-200 dark:border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
                    ...
                    <div className="flex gap-8">
                        ...
                        <Link href="https://linkedin.com/in/naveen2k" target="_blank" className="text-zinc-400 dark:text-zinc-500 hover:text-zinc-900 dark:hover:text-white transition-colors duration-300 transform hover:scale-110" aria-label="LinkedIn Profile">
                            <Linkedin size={20} />
                        </Link>
                        <Link href="mailto:naveen.s.connect@gmail.com" className="text-zinc-400 dark:text-zinc-500 hover:text-zinc-900 dark:hover:text-white transition-colors duration-300 transform hover:scale-110" aria-label="Email Me">
                            <Mail size={20} />
                        </Link>
                    </div>
                </div>
