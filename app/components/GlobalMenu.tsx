...
const menuItems: { category: string; items: MenuItem[] }[] = [
    {
        ...
        items: [
            ...
            { name: 'Work', href: '/#work-section', icon: Briefcase, description: 'View my selected work' },
            { name: 'Journey', href: '/#journey-section', icon: Command, description: 'Career & Education' },
