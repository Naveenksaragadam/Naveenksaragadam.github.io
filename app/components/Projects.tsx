...
const projects = [
    {
        ...
        description: "Production-grade platform processing 70+ years of Formula 1 race data (10M+ records) with sub-second analytics using ClickHouse, Airflow, and MinIO.",
        techStack: ['Python', 'Airflow', 'ClickHouse', 'dbt', 'MinIO', 'Docker', 'Superset'],
        highlights: [
            "Bronze → Silver → Gold lakehouse layers with dbt",
            "Orchestrated ingestion and transformations with Airflow",
            "Interactive Superset dashboards powered by ClickHouse"
        ],
        color: "bg-red-600",
        link: "https://github.com/Naveenksaragadam/f1_pipeline"
    },
    {
        title: "SQL Data Warehouse",
        category: "Data Modeling",
        description: "Robust PostgreSQL data warehouse implementation using a star schema to support business intelligence and analytics workloads.",
        techStack: ['PostgreSQL', 'SQL', 'Star Schema', 'ETL'],
        highlights: [
            "Designed fact and dimension tables for analytics",
            "Built repeatable ETL workflows for curated data",
            "Structured for clear, performant BI reporting"
        ],
        color: "bg-blue-600",
        link: "https://github.com/Naveenksaragadam/sql-data-warehouse-project"
    },
    {
        title: "HR Analytics Dashboard",
        category: "Visualization",
        description: "Interactive Tableau dashboard for exploring workforce trends and the key performance indicators that inform HR decisions.",
        techStack: ['Tableau', 'SQL', 'Data Visualization'],
        highlights: [
            "Clear KPI views for workforce and performance trends",
            "Interactive Tableau exploration for faster analysis",
            "Built for actionable HR reporting"
        ],
        color: "bg-yellow-500",
        link: "https://public.tableau.com/views/HRDashboard2_17455649649000/HRSummary?:language=en-US&:sid=&:redirect=auth&:display_count=n&:origin=viz_share_link"
    }
]
        ...
        <section id="work" className="relative z-10 w-full py-32 px-4 md:px-12 transition-colors duration-500 overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <motion.p
                    ...
                    viewport={{ once: true }}
                    className="text-zinc-500 dark:text-zinc-400 text-lg mb-20 max-w-2xl"
                >
                    Open-source data platforms, warehouse design, and analytics visualization.
                </motion.p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {projects.map((project, index) => (
                        <motion.a
                            ...
                            viewport={{ once: true }}
                            className="group relative h-[520px] w-full overflow-hidden rounded-3xl bg-gray-50 dark:bg-white/[0.03] border border-gray-200 dark:border-white/[0.08] backdrop-blur-md transition-all duration-500 hover:bg-gray-100 dark:hover:bg-white/[0.08] hover:scale-[1.02] hover:shadow-2xl hover:shadow-blue-500/20 block cursor-pointer"
                            suppressHydrationWarning
                        >
                            {/* Color Gradient Mesh Background */}
                            <div className={`absolute -top-20 -right-20 w-64 h-64 rounded-full blur-[100px] opacity-20 group-hover:opacity-40 transition-opacity duration-700 ${project.color}`} />
                            ...
                            <div className="relative z-10 h-full flex flex-col justify-between p-8 md:p-10">
                                <div className="space-y-4 transform transition-transform duration-500 group-hover:-translate-y-2">
                                    ...
                                    <p className="text-gray-600 dark:text-white/70 text-base leading-relaxed line-clamp-3 font-light">
                                        {project.description}
                                    </p>
