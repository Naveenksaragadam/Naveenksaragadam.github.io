                    ...
                    <div className="fixed inset-0 z-[101] flex items-end justify-center p-4 pointer-events-none">
                        ...
                        >
                            ...
                            <div className="p-8 pt-2 space-y-6">
                                ...
                                {/* Email */}
                                    <Link
                                        href="mailto:naveen.s.connect@gmail.com"
                                        className="group p-6 bg-zinc-50 dark:bg-white/5 border border-zinc-200 dark:border-white/10 rounded-3xl hover:bg-zinc-100 dark:hover:bg-white/[0.08] hover:border-zinc-300 dark:hover:border-white/20 transition-all duration-300"
                                    >
                                        <div className="w-10 h-10 rounded-xl bg-white dark:bg-white/5 border border-zinc-100 dark:border-transparent flex items-center justify-center mb-4 group-hover:scale-110 transition-transform shadow-sm dark:shadow-none">
                                        ...
                                        <p className="text-zinc-500 dark:text-white/40 text-sm">naveen.s.connect@gmail.com</p>
                                    </Link>
                                </div>
                                ...
                                <div className="pt-4 text-center">
                                    ...
                                    <div className="flex justify-center gap-8 pb-4">
                                        <Link href="https://linkedin.com/in/naveen2k" target="_blank" className="text-zinc-400 hover:text-zinc-900 dark:text-white/40 dark:hover:text-white transition-all transform hover:scale-110">
                                        ...
                                        <Link href="mailto:naveen.s.connect@gmail.com" className="text-zinc-400 hover:text-zinc-900 dark:text-white/40 dark:hover:text-white transition-all transform hover:scale-110">
