...
const education = [
    {
        ...
        gpa: "3.8 / 4.00",
        courses: [
            { name: "Machine Learning", slug: "scikitlearn", color: "F7931E" },
            { name: "Data Mining and Discovery", slug: "databricks", color: "FF3621" },
            { name: "Data Analysis & Visualization", slug: "tableau", color: "E97627" },
            { name: "Predictive Analytics", slug: "python", color: "3776AB" },
            { name: "Database Systems", slug: "postgresql", color: "4169E1" }
        ],
        projects: "F1 Racing Analytics Platform (Bronze -> Silver -> Gold dbt + Superset)"
    },
    {
        ...
        courses: [
            ...
            { name: "Data Structures & Algorithms", slug: "java", color: "007396" },
            { name: "Software Engineering", slug: "git", color: "F05032" },
            { name: "Fundamentals of Computing", slug: "cplusplus", color: "00599C" },
            { name: "AI and Expert Systems", slug: "openai", color: "412991" }
        ],
        projects: "Competitor Pricing & Supply Chain Intelligence Pipeline"
    }
]
                        ...
                        >
                            ...
                            <div className="pl-0 md:pl-12 mt-8 md:mt-0">
                                ...
                                <div className="mb-6">
                                    ...
                                    {edu.specialization && (
                                        <p className="text-sm md:text-base font-medium text-purple-600 dark:text-purple-400 font-mono tracking-wide">
                                            {edu.specialization}
                                        </p>
                                    )}
                                </div>
                                ...
                                <motion.div
                                    ...
                                    className="space-y-8 bg-white/80 dark:bg-[#0d1117]/80 border border-zinc-200/50 dark:border-white/10 rounded-3xl p-8 md:p-10 max-w-3xl shadow-xl dark:shadow-2xl backdrop-blur-md transition-colors duration-300"
                                >
                                    {edu.projects && (
                                        <div>
                                            <p className="text-sm font-bold text-zinc-500 uppercase tracking-widest mb-2 leading-none">Focus</p>
