        ...
        <section className="max-w-7xl mx-auto px-6 pb-40">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <motion.div
                    ...
                    viewport={{ once: true }}
                    className="group bg-[#111] rounded-3xl p-8 border border-white/5 hover:border-white/10 transition-colors relative overflow-hidden"
                >
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div className="flex flex-col items-center gap-2 p-4 bg-white/5 rounded-2xl group-hover:bg-white/10 transition-colors">
                            <Code2 className="w-8 h-8 text-blue-400" />
                            <span className="text-xs text-zinc-400">VS Code</span>
                        </div>
                        <div className="flex flex-col items-center gap-2 p-4 bg-white/5 rounded-2xl group-hover:bg-white/10 transition-colors">
                            <Box className="w-8 h-8 text-orange-400" />
                            <span className="text-xs text-zinc-400">dbt</span>
                        </div>
                        <div className="flex flex-col items-center gap-2 p-4 bg-white/5 rounded-2xl group-hover:bg-white/10 transition-colors">
                        ...
                        <div className="flex flex-col items-center gap-2 p-4 bg-white/5 rounded-2xl group-hover:bg-white/10 transition-colors">
                            ...
                            <span className="text-xs text-zinc-400">MinIO</span>
                        </div>
                    </div>
                </motion.div>
                ...
                <motion.div
                    ...
                    viewport={{ once: true }}
                    className="group bg-[#111] rounded-3xl p-8 border border-white/5 hover:border-white/10 transition-colors flex flex-col justify-between relative overflow-hidden"
                >
                    ...
                    <div>
                        ...
                        <div className="text-2xl font-serif text-white">Let me know you were here.</div>
                    </div>
                    ...
                    <div className="relative mt-8">
                        <input
                            ...
                            className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-zinc-600 focus:outline-none focus:border-white/20 transition-colors"
                        />
                        <button className="absolute right-2 top-1/2 -translate-y-1/2 p-1.5 bg-white text-black rounded-lg hover:bg-zinc-200 transition-colors">
                ...
                >
                    ...
                    <div className="flex items-center gap-4">
                        <div className="w-16 h-16 bg-zinc-800 rounded-lg flex items-center justify-center relative group-hover:scale-105 transition-transform">
                            {/* Mock Album Art */}
                            <div className="absolute inset-0 bg-gradient-to-br from-zinc-700 to-black rounded-lg" />
