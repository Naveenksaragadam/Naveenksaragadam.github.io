...
// Data Analyst & Analytics Engineering tools from Naveen's Data Analyst resume
const tools = [
    ...
    { name: 'ClickHouse', icon: 'https://cdn.simpleicons.org/clickhouse/F8D000' },
        ...
        >
            ...
            <div className="relative flex flex-col items-center justify-center gap-8 py-10 w-full">
                    ...
                    <div className="flex w-max">
                        ...
                        >
                            {[...tools, ...tools].map((tool, index) => (
                                <div
                                    key={`${tool.name}-${index}`}
                                    className="relative w-16 h-16 flex-shrink-0 bg-zinc-900/80 rounded-2xl border border-white/5 flex flex-col items-center justify-center p-2 gap-1 group/icon hover:border-white/20 hover:bg-zinc-800 transition-all duration-300"
                                >
                                    ...
                                    <span className="text-[8px] text-zinc-600 group-hover/icon:text-zinc-400 transition-colors truncate max-w-full px-0.5 text-center leading-none">{tool.name}</span>
                                </div>
                            ))}
                        </motion.div>
                    </div>
                ...
                <div className="text-center space-y-1 relative z-10">
                    <span className="text-[10px] uppercase tracking-[0.2em] text-zinc-500 font-bold">Data &amp; Analytics Toolkit</span>
                    <h3 className="text-base font-medium text-zinc-300">Technologies I use to build data pipelines &amp; BI</h3>
                </div>
            </div>
